    ...
    <div className="an2 an2-detail">
      <div style={{ paddingTop: 32 }}>
        ...
        <header className="an2-detail__head">
          <div>
            ...
            <p className="an2-detail__sub">
              Push isn&apos;t a follower count — it&apos;s a{" "}
              <strong>physical-world conversion measurement</strong>. Five
              verification layers turn a scan into a paid event. The decay curve
              turns a visit into recurring revenue. Last-click attribution sets
              the rules between competing creators.
            </p>
          </div>
        ...
        <section className="an2-card" style={{ marginBottom: 32 }}>
          <p className="an2-card__eyebrow">
            6-month rail · raw vs verified vs repeat
          </p>
        ...
        <div className="an2-grid-2">
          ...
          <section className="an2-card">
            ...
            >
              When a fan returns, attribution doesn&apos;t lock to you forever —
              it decays. This is FTC compliance + Push&apos;s differentiation.
              Re-engaging fans before they age out resets their tier and
                ...
                [
                  {
                    ...
                    label: "0–7 days",
                    weight: "100%",
                    note: "First visit · full attribution",
                  },
                  {
                    tier: "d50",
                    label: "8–14 days",
                    weight: "50%",
                    note: "Half credit · still recoverable",
                  },
                  {
                    tier: "d30",
                    label: "15–21 days",
                    weight: "30%",
                    note: "Window closing · re-engage now",
                  },
                  {
                    tier: "d10",
                    label: "22–28 days",
                    weight: "10%",
                    note: "Last call · post a follow-up",
                  },
                  {
                    tier: "expired",
                    label: "29+ days",
                    weight: "0%",
                    note: "Window closed · attribution lost",
                  },
                ] as {
                  tier: DecayTier;
                  label: string;
        ...
        <section className="an2-card" style={{ marginTop: 32 }}>
          ...
          <h2 className="an2-card__title">
            Last-click — and how to keep yours
          </h2>
          <p
            style={{
              fontFamily: "var(--font-body)",
          ...
          >
            When two creators promote the same merchant,{" "}
            <strong>
              the most recently used referral link gets full attribution
            </strong>
            . If your fan clicks Creator B&apos;s link after yours, attribution
            flips to B — even if your post drove the original visit.
          </p>
          <div
            style={{
              display: "grid",
          ...
          >
            ...
            >
              ...
              >
                Mon — fan clicks your Blank Street link. Tue — fan visits store.{" "}
                <strong
                  style={{
                    fontFamily: "var(--font-display)",
                    color: "var(--ink)",
            ...
            >
              ...
              >
                Wed — fan clicks Creator B&apos;s link. Thu — fan returns.{" "}
                <strong
                  style={{
                    fontFamily: "var(--font-display)",
                    color: "var(--ink)",
            ...
            >
              ...
              >
                Fri — you post a follow-up. Fan clicks again.{" "}
                <strong
                  style={{
                    fontFamily: "var(--font-display)",
                    color: "var(--ink)",
        ...
        <p className="an2-div">
          <span>scan · verify · attribute · renew.</span>
        </p>
      </div>
    </div>
  );
