    ...
    <div className="an2 an2-detail">
      <div style={{ paddingTop: 32 }}>
        ...
        <header className="an2-detail__head">
          <div>
            ...
            <p className="an2-detail__sub">
              Push pays you three ways: <strong>base pay</strong> per accepted
              campaign, <strong>commission</strong> on attributed transactions
              in the 30-day window, and <strong>milestone bonus</strong> when
              you cross monthly referral thresholds. The mix tells you what's
              actually working.
            </p>
          </div>
        ...
        <div className="an2-grid-2">
          ...
          <section className="an2-card">
            ...
            <div className="an2-eb">
              ...
              <div
                className="an2-eb__row"
                style={{
                  marginTop: 12,
                  paddingTop: 12,
                  borderTop: "1px solid var(--hairline, var(--mist))",
                }}
              >
                <span className="an2-eb__lbl" style={{ color: "var(--ink)" }}>
                  Total
                </span>
                <div />
                <span className="an2-eb__val" style={{ fontSize: 24 }}>
                  {fmtUsd(total)}
                </span>
              </div>
            </div>
            ...
            >
              ...
              >
                {Math.round((earnings.milestone / total) * 100)}%
              </strong>{" "}
              of this month's earnings. It's the highest-leverage line — at
              Operator, $0.18 commission on a $7 coffee is rounding error; the
              milestone +$15 is the actual lever.
            </div>
          </section>
              ...
              {PER_CAMPAIGN_EARNINGS.map((c) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div
                        style={{ flex: c.base, background: "var(--ink)" }}
                        title={`Base $${c.base}`}
                      />
                      <div
                        style={{
                    ...
                    >
                      ...
                      <span style={{ marginLeft: "auto" }}>
                        ...
                        {Math.round(c2.repeatPct * 100)}% repeat
                      </span>
                    </div>
                  </div>
                );
        ...
        <section className="an2-card" style={{ marginTop: 32 }}>
          ...
          >
            Steady growth from ~${trajectory[0].earnings} to $
            {trajectory[trajectory.length - 1].earnings} over 6 months. Crossing
            into{" "}
            <strong
              style={{
                fontFamily: "var(--font-display)",
            ...
            (5% commission, $25–40/campaign) projects $
            {Math.round(trajectory[trajectory.length - 1].earnings * 1.85)} at
            the same campaign volume.
          </p>
        </section>

        <p className="an2-div">
          <span>posted · scanned · paid.</span>
        </p>
      </div>
    </div>
  );
