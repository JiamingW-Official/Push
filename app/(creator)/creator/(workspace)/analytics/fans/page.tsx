    ...
    <div className="an2 an2-detail">
      <div style={{ paddingTop: 32 }}>
        ...
        <header className="an2-detail__head">
          <div>
            ...
            <p className="an2-detail__sub">
              Anonymous fans who came back through your referral. This is what
              Push measures that Instagram cannot. Each fan moves through the{" "}
              <strong>v5.4 Attribution Decay Curve</strong> — 100% → 50% → 30% →
              10% → 0% as their last visit ages out the 30-day window. Re-engage
              before they decay.
            </p>
          </div>
        ...
        <section style={{ marginBottom: 32 }}>
          ...
          <h2 className="an2-card__title" style={{ marginBottom: 20 }}>
            How fresh your attribution is
          </h2>
          <div
            className="an2-grid-3"
              ...
              return (
                <div key={seg.tier} className="an2-bucket">
                  <span className="an2-bucket__title">
                    <span
                      className="an2-bucket__swatch"
                      style={{ background: colorVal }}
                    />
                    {labelParts[0]}
                  </span>
                  <p className="an2-bucket__sub">
                    {labelParts.slice(1).join(" ") || ""}
                  </p>
                  <p
                    className="an2-bucket__num"
                    style={{
                      color:
                        seg.tier === "expired" ? "var(--ink-5)" : "var(--ink)",
                    }}
                  >
                    {seg.count}
                  </p>
        ...
        <div className="an2-grid-2">
              ...
              {sortedFans.map((f, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      <span style={{ color: "var(--ink-5)" }}>fan_</span>
                      {f.id}
                    </p>
                    <p
                      style={{
                  ...
                  <span className={`an2-decay-pill ${f.decay}`}>
                    {DECAY_LABEL[f.decay].split(" ")[0]}
                  </span>
                </div>
              ))}
            </div>
          ...
          <section className="an2-card">
            <p className="an2-card__eyebrow">
              Expiring this week · action queue
            </p>
            ...
            <div>
              ...
              {expiring.map((f) => (
                <div
                  ...
                  style={{
                    padding: "14px 0",
                    borderBottom: "1px solid var(--hairline, var(--mist))",
                  }}
                >
                  <div
                    style={{
        ...
        <p className="an2-div">
          <span>returned · attributed · renewed.</span>
        </p>
      </div>
    </div>
  );
