      ...
      <div style={{ paddingTop: 32 }}>
        ...
        <header className="an2-detail__head">
          <div>
            ...
            <p className="an2-detail__sub">
              Per push-creator §commission, the milestone bonus is the actual
              lever — at Operator, hitting <strong>30 referrals/month</strong>{" "}
              unlocks <strong>+$15</strong>. Pure 3% commission on $7 coffee
              transactions yields rounding error; this is where real income
              lives.
            </p>
          </div>
        ...
        <section className="an2-card" style={{ marginBottom: 32 }}>
          <p className="an2-card__eyebrow">
            {MILESTONE.hit ? "Hit · this window" : "In progress · this window"}
          </p>
          <div
            style={{
              display: "grid",
              ...
              >
                {MILESTONE.hit ? (
                  <>
                    ...
                    . Bonus paid this cycle. Window resets{" "}
                    <strong
                      style={{
                        fontFamily: "var(--font-display)",
                        color: "var(--ink)",
                    ...
                    >
                      {MILESTONE.windowResetsAt}
                    </strong>
                    .
                  </>
                ) : (
                  <>
                    {MILESTONE.threshold - MILESTONE.current} referrals to go ·
                    window resets{" "}
                    <strong
                      style={{
                        fontFamily: "var(--font-display)",
          ...
          >
            <div
              style={{
                ...
                background: "linear-gradient(90deg, var(--champagne), #d4b988)",
                borderRadius: 7,
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          right: 0,
                          bottom: `${(30 / 40) * 100}%`,
                          borderTop: "1px dashed var(--ink-5)",
                        }}
                      />
                      <div
                        style={{
                    ...
                    <span
                      style={{
                        ...
                        fontWeight: 700,
                        fontSize: 12,
                        color: h.hit ? "var(--champagne)" : "var(--ink-5)",
                        fontVariantNumeric: "tabular-nums",
                      }}
                    >
                      {ref}
          ...
          <section className="an2-card">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              >
                ...
                >
                  Annual upside (if hit every month)
                </p>
                <p
                  style={{
                    fontFamily: "var(--font-display)",
        ...
        <p className="an2-div">
          <span>thirty by month-end · then thirty more.</span>
        </p>
      </div>
    </div>
  );
