  ...
  return (
    ...
    >
      <div style={{ maxWidth: 480, width: "100%" }}>
        ...
        >
          We couldn&apos;t load your creator profile right now. Your identity
          and verification data are safe — try again or return to the dashboard.
        </p>
