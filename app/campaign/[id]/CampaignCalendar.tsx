...
export function CampaignCalendar({
  ...
  return (
    <div className="cd-cal">
      ...
      {/* Day grid */}
      <div className="cd-cal__grid" role="grid">
        {cells.map((cell, i) => {
          if (cell.kind === "blank") {
            return <span key={`b-${i}`} className="cd-cal__cell cd-cal__cell--blank" />;
          }
          ...
          return (
            <button
              ...
              disabled={!bookable}
              aria-label={`${cell.day} ${monthLabel}${bookable ? ` · ${w.slots.length} slots` : ""}`}
            >
