...
function toastStyle(kind: ToastKind): React.CSSProperties {
  ...
  return {
    ...
    width: "320px",
    padding: "12px 16px",
    border: `2px solid ${isError ? "var(--primary)" : "var(--dark)"}`,
    background: isError ? "var(--primary)" : "var(--surface)",
    color: isError ? "#fff" : "var(--dark)",
...
function toastTag(kind: ToastKind): React.CSSProperties {
  ...
  return {
    ...
    width: "20px",
    height: "20px",
    background: isError ? "var(--surface-elevated)" : "var(--dark)",
    color: isError ? "var(--primary)" : "var(--surface)",
    fontWeight: 800,
    fontSize: "12px",
    flexShrink: 0,
  };
