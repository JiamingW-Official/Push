...
const PAGE_ITEMS: SearchItem[] = [
  ...
  // Creator workspace routes
  {
    ...
    score: 95,
    keywords: ["dashboard", "creator", "earnings", "analytics", "home"],
  },
  {
    type: "page",
    id: "page-creator-discover",
    title: "Discover Campaigns",
    subtitle: "Find new campaigns to apply for",
    url: "/creator/explore",
    score: 92,
    keywords: ["discover", "explore", "campaigns", "find", "apply", "new"],
  },
  {
    type: "page",
    id: "page-creator-calendar",
    title: "Calendar",
    subtitle: "Scheduled visits and upcoming deadlines",
    url: "/creator/calendar",
    score: 88,
    keywords: ["calendar", "schedule", "visits", "deadlines", "upcoming"],
  },
  {
    type: "page",
    id: "page-creator-messages",
    title: "Inbox",
    subtitle: "Messages from brands and Push support",
    url: "/creator/messages",
    score: 86,
    keywords: ["inbox", "messages", "chat", "brands", "support", "dm"],
  },
  {
    type: "page",
    id: "page-creator-portfolio",
    title: "Portfolio",
    subtitle: "Your published content and performance metrics",
    url: "/creator/portfolio",
    score: 85,
    keywords: ["portfolio", "content", "posts", "published", "work"],
  },
  {
    type: "page",
    id: "page-creator-earnings",
    title: "Earnings",
    subtitle: "Payouts history and pending balance",
    url: "/creator/earnings",
    score: 84,
    keywords: ["earnings", "payouts", "money", "balance", "income", "wallet"],
  },
  {
    type: "page",
    id: "page-creator-wallet",
    title: "Wallet",
    subtitle: "Connect your bank and manage withdrawals",
    url: "/creator/wallet",
    score: 83,
    keywords: ["wallet", "bank", "withdraw", "payout", "stripe", "connect"],
  },
  {
    type: "page",
    id: "page-creator-analytics",
    title: "Analytics",
    subtitle: "Impressions, reach, and conversion stats",
  ...
  {
    type: "page",
    id: "page-creator-leaderboard",
    title: "Leaderboard",
    subtitle: "Top creators ranked by earnings and performance",
    url: "/creator/leaderboard",
    score: 78,
    keywords: ["leaderboard", "ranking", "top", "creators", "competition"],
  },
  {
    type: "page",
    id: "page-creator-notifications",
    title: "Notifications",
    subtitle: "Activity feed and alerts",
    url: "/creator/notifications",
    score: 76,
    keywords: ["notifications", "alerts", "activity", "feed", "updates"],
  },
  {
    type: "page",
    ...
    url: "/creator/profile",
    score: 80,
    keywords: ["profile", "creator", "tier", "settings", "bio", "handle"],
  },
  {
    type: "page",
    id: "page-creator-settings",
    title: "Settings",
    subtitle: "Account, notifications, and privacy settings",
  ...
  {
    type: "page",
    id: "page-creator-disputes",
    title: "Disputes",
    subtitle: "Open cases and resolution history",
    url: "/creator/disputes",
    score: 68,
    keywords: ["disputes", "cases", "resolution", "issues", "problems"],
  },
  // Merchant portal
  {
    type: "page",
